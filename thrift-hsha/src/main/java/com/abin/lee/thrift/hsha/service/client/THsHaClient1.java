package com.abin.lee.thrift.hsha.service.client;
...
public class THsHaClient1 {
    ...
    public class AsynCallback implements AsyncMethodCallback<HelloService.AsyncClient.sayHello_call> {
...
//        }
    ...
    public static void main(String[] args) {
        THsHaClient1 client = new THsHaClient1();
